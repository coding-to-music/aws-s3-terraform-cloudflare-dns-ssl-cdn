...
resource "cloudflare*page_rule" "https" {
zone_id = data.cloudflare_zones.domain.zones[0].id
target = "*.${var.site*domain}/*"
actions {
...
id = "REDACTED"
~ priority = 2 -> 1 # (3 unchanged attributes hidden)
...
- resource "cloudflare_page_rule" "redirect-to-learn" {
  ...
  - actions { - always_use_https = false -> null - disable_apps = false -> null - disable_performance = false -> null - disable_railgun = false -> null - disable_security = false -> null - edge_cache_ttl = 0 -> null
